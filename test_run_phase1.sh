PYTHONPATH=. torchrun --nproc_per_node 2 scripts/train_phase1.py --epochs 1 --output checkpoints/phase1/test --max-seq-len 512
  ...
  PYTHONPATH=. torchrun --nproc_per_node 2 scripts/train_phase1.py --model Qwen/Qwen3-4B-Thinking-2507 --output checkpoints/phase1_4B/final --epochs 3                            
                                                                                                                                                                      
  After that finishes, Phase 2 GRPO:                                                                                                                                  
                                                                                                                                                                      
  # Phase 2 GRPO (single GPU, ref model on same GPU)        
  python -m scripts.train_phase2 --base-model Qwen/Qwen3-4B-Thinking-2507 --phase1 checkpoints/phase1_4B/final --steps 500 --num-rollouts 16 --batch-size 2 --output              
...
PYTHONPATH=. torchrun --nproc_per_node 2 scripts/train_phase1.py --model Qwen/Qwen3-4B-Thinking-2507 --output checkpoints/phase1_4B/final_fixed --epochs 3 
